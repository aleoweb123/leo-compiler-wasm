...
impl<'a> Compiler<'a> {
    ...
    pub fn parse_program(&mut self,program_string: String) -> Result<()> {
        ...
        self.parse_program_from_string(&program_string, FileName::Custom("main".to_string()))
    }
    ...
    pub fn compile(&mut self,program_string: String) -> Result<(SymbolTable, String)> {
        // Parse the program.
